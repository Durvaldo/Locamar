                    ...
                    <div className="flex flex-wrap justify-center gap-5">
                        <div className="container-card">
                            ...
                            <div className="flex flex-col justify-around mr-5 h-full cursor-default items-center">
                                ...
                                <p className="text-justify text-xs sm:text-sm md:text-base">Locação de caçambas para descarte responsável de entulhos em eventos, construções e mais. Grandes quantidades disponíveis, transporte e descarte seguros. </p>
